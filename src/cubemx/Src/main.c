...
void PeriphCommonClock_Config(void) {
  ...
  PeriphClkInitStruct.PeriphClockSelection =
      RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_FDCAN | RCC_PERIPHCLK_CKPER;
...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOE,
                    IMU_CS1_Pin | IMU_CS2_Pin | IMU_CS3_Pin | LED_Pin |
                        BOOT_Pin | IMU_FSYNC_Pin,
                    GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(
      GPIOB, BAT_CHRG_nSHDN_Pin | BMS_EN_Pin | FRONT_EN_Pin | RL_PUMP_EN_Pin,
      GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD,
                    F_INV_EN_Pin | RSM_EN_Pin | R_INV_EN_Pin |
  ...
  /*Configure GPIO pins : RR_ILCK_3V3_OUT_Pin BMS_PG_Pin INERTIA_3V3_OUT_Pin
     PWR_MTR_nALERT_Pin BOOST_PG_Pin BAT_CHRG_MODE_Pin */
  GPIO_InitStruct.Pin = RR_ILCK_3V3_OUT_Pin | BMS_PG_Pin | INERTIA_3V3_OUT_Pin |
                        PWR_MTR_nALERT_Pin | BOOST_PG_Pin | BAT_CHRG_MODE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : R_INV_PG_Pin F_INV_PG_Pin SB_SHDN_3V3_OUT_Pin
     MISC_FUSE_PG_Pin L_RAD_FAN_PG_Pin R_RAD_FAN_PG_Pin */
  GPIO_InitStruct.Pin = R_INV_PG_Pin | F_INV_PG_Pin | SB_SHDN_3V3_OUT_Pin |
                        MISC_FUSE_PG_Pin | L_RAD_FAN_PG_Pin | R_RAD_FAN_PG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Pin = F_INV_EN_Pin | RSM_EN_Pin | R_INV_EN_Pin |
                        MISC_FUSE_EN_Pin | R_RAD_FAN_EN_Pin | L_RAD_FAN_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
